          ...
          <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
              <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                  ...
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                      ...
                      <li>
                          <a href="usuarios.php" class="nav-link align-middle px-0 navbar-brand text-info">
              ...
              <form action="insertar.php" method="post"> <!--id="formulario" method="POST" -->
                <h1 class="container-title">Registar Usuario</h1>
                  <div class="container-form">
                    <label for="txt_username" class="form-label">ID Usuario:</label>
                    <input type="text" class="form-control" id="txt_username" name="username" placeholder="Ingrese su id de usuario" name="id">
                    <label for="txt_password" class="form-label">Contraseña:</label>
                    <input type="password" class="form-control" id="txt_password" name="password" placeholder="Ingrese su contraseña" name="password">
                    ...
                    <input type="text" class="form-control" id="txt_marca_s" name="marcas" placeholder="Código marca" name="marcas">
