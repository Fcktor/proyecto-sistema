<?php
  ...
  $categoria = "SELECT * FROM categoria_producto";
  session_start();
?>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="maincate.css">
      ...
      <div class="row flex-nowrap">
                  ...
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                      ...
                      <li>
                          <a href="../categorias/categorias.php" class="nav-link px-0 align-middle">
                              <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline"  id="texto">Categorías</span></a>
                      </li>
          ...
          <div class="col-8"> <!--Aquí va el contenido -- class col py-3-->
            ...
            <div class="container-add">
              <form action="insertarcategoria.php" method="post"> <!--id="formulario" method="POST" -->
                <h1 class="container-title">Registar Pedido</h1>
                  <div class="container-form">
                    <label for="txt_desccat" class="form-label">Descripción de Categoría:</label>
                    <input type="text" class="form-control" id="txt_desccat" name="desccat" placeholder="Descripción">
                    <label for="txt_estadocat" class="form-label">Estado de Categoría:</label>
                    <input type="text" class="form-control" id="txt_estadocat" name="estadocat" placeholder="Estado">
              ...
              <div class="container-tabla">
                <div class="titulo-tabla">Datos de Categoría<a href="modificarcategoria.php" class="title-edit">Modificar</a></div>
                ...
                <div class="tabla-item"><?php echo $row["descrip_categ"];?></div>
                <div class="tabla-item"><?php echo $row["estado_categ"];?></div>
