<?php
  ...
  $marca = "SELECT * FROM marca_producto";
  session_start();
?>
      ...
      <div class="row flex-nowrap">
          ...
          <div class="col-8"> <!--Aquí va el contenido -- class col py-3-->
            ...
            <div class="container-add">
              ...
              <div class="container-tabla container_marcap_modificar">
                <div class="titulo-tabla titulo-marcap_edit">Datos de Marca producto</div>
                ...
                <div class="tabla-item">
                    <a href="editar.php?cod=<?php echo $row["cod_marca_p"];?>" class="tabla-item-link">Editar</a> -
                    <a href="eliminar.php?cod=<?php echo $row["cod_marca_p"];?>" class="tabla-item-link">Eliminar</a>
                </div>
