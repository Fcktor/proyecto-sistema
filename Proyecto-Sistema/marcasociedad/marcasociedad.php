<?php
  ...
  $marca = "SELECT * FROM marca_sociedad";
  session_start();
?>
...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Registrar Marca Sociedad</title>
      ...
      <div class="row flex-nowrap">
                  ...
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                      ...
                      <li>
                          <a href="../marcasociedad/marcasociedad.php" class="nav-link px-0 align-middle">
                              <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline"  id="texto">Marca Sociedad</span></a>
                      </li>
          ...
          <div class="col-8"> <!--Aquí va el contenido -- class col py-3-->
            ...
            <div class="container-add">
              <form action="insertarmarcaso.php" method="post"> <!--id="formulario" method="POST" -->
                <h1 class="container-title">Registar Marca sociedad</h1>
                  <div class="container-form">
                    <label for="txt_marcas" class="form-label">Descripción de marca sociedad:</label>
                    <input type="text" class="form-control" id="txt_marcas"" name="descripmarcas" placeholder="Descripción">
                    <label for="txt_tel" class="form-label">Teléfono:</label>
                    <input type="text" class="form-control" id="txt_tel" name="tel" placeholder="Teléfono">
                    <label for="txt_dir" class="form-label">Dirección:</label>
                    <input type="text" class="form-control" id="txt_dir" name="dir" placeholder="Dirección">
                    <label for="txt_ruc" class="form-label">Ruc:</label>
                    <input type="text" class="form-control" id="txt_ruc" name="ruc" placeholder="RUC">
              ...
              <div class="container-tabla">
                <div class="titulo-tabla">Datos de Marca Sociedad<a href="modificarmarcasso.php" class="title-edit">Modificar</a></div>
                ...
                <div class="tabla-item"><?php echo $row["descrip_marca_s"];?></div>
                <div class="tabla-item"><?php echo $row["telef_marca_s"];?></div>
                <div class="tabla-item"><?php echo $row["direccion_marca_s"];?></div>
                <div class="tabla-item"><?php echo $row["ruc"];?></div>
